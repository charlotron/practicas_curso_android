...
import com.worldpcs.tiendecitas4.data.adapters.CommunityListAdapter;
import com.worldpcs.tiendecitas4.data.pojo.Photo;
import com.worldpcs.tiendecitas4.util.FileUtils;

public class CommunityFragment extends Fragment implements OnRefreshListener {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
	    ...
	    mPullToRefreshLayout = (PullToRefreshLayout) getActivity().findViewById(R.id.refresh_layout);
	    
	    reconfigurePullToRefreshLayout();
	}
	public void reconfigurePullToRefreshLayout(){
	...
	public void onRefreshStarted(View view) {
		DataProvider.getInstance().updateAllPhotos(getActivity(),true);	
	}
}
